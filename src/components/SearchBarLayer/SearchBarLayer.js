...
export default function SearchBarLayer() {
    ...
    return (
        <div className="searchBar-layer-container fixed top-[100px] rounded-lg lg:right-[10%] right-[50%] translate-x-[50%] lg:translate-x-0 lg:w-[30%] md:w-[80%] w-[90%] lg:h-[84vh] h-[600px] dark:bg-[#07070783] bg-[#e8e6e6a7] backdrop-blur-3xl z-[9999]  dark:border-[#2f2f2f] border-[.5px] border-[#cecece] pt-16">
